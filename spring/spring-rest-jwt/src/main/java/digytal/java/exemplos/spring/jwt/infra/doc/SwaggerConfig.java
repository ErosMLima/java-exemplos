package digytal.java.exemplos.spring.jwt.infra.doc;
...
public class SwaggerConfig {
	...
	public Docket detalheApi() {
		...
		.select()
		.apis(RequestHandlerSelectors.basePackage("digytal.java.exemplos.spring.jwt.resource"))
	...
	private ApiInfoBuilder informacoesApi() {
		...
		apiInfoBuilder.title("Digytal - Springboot JWT");
		apiInfoBuilder.description("API exemplo de uso de Springboot com JWT");
